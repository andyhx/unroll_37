...
% load('lightencnn_gallery_feature.mat');
% load('lightencnn_probe_feature.mat');

% load('softmax_gallery_feature.mat');
% load('softmax_probe_feature.mat');

load('ori_img_gallery_feature.mat');
load('ori_img_probe_feature.mat');

% load('centerloss_gallery_feature.mat');
% load('centerloss_probe_feature.mat');
do_val=true;
if do_val
...
total_feature_num=length(probe_feature);
roc_interval=10;
