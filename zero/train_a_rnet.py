...
solver=caffe.SGDSolver('zero/A_Rnet/solver.prototxt')
#solver.net.copy_from('zero/a_net/base1_iter_40000.caffemodel')
solver.net.copy_from('zero/R_net/test_Rnet/snapshot/rnet__iter_1000000.caffemodel')
solver.net.copy_from('zero/A_net/snapshot_with_weight/snapshot_with_weight_v1/a_net_iter_3400.caffemodel')
