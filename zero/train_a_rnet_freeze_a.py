...
solver=caffe.SGDSolver('zero/A_Rnet/solver_freeze_a.prototxt')
#solver.restore('zero/A_Rnet/snapshot_freeze_a/a_rnet_iter_27000.solverstate')
solver.net.copy_from('zero/a_net/snapshot_with_weight_v1/a_net_iter_3400.caffemodel')
